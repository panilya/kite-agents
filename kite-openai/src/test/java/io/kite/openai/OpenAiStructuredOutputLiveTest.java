...
/**
 * Live round-trip tests for structured outputs — schema emission → OpenAI acceptance →
 * response JSON → record materialization. One test per shape we claim to support.
 *
 * <p>Gated on {@code OPENAI_API_KEY} and the {@code live} JUnit tag.
 * Run with {@code ./gradlew :kite-openai:liveTest}. Cheapest model, shallow assertions.
 */
@Tag("live")
@EnabledIfEnvironmentVariable(named = "OPENAI_API_KEY", matches = ".+")
class OpenAiStructuredOutputLiveTest {
